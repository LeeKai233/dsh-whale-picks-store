...
鲸选商店入口：在 DSH 设置侧栏「Agent 预设」下方加入鲸选区块——浏览套件与精选插件、九轴 Braille ASCII 雷达、创始人评分与手记、体检结论，一键复制安装命令。纯文本 UI，无 emoji。
...
- 已收录插件展示九轴 Braille ASCII 雷达（范式九目标机器轴）、创始人评分与手记、体检发现与规范门槛状态
- 一键复制确切的安装命令
